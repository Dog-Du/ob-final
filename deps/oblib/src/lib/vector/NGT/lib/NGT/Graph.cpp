...
static void
fvec_L2sqr_batch_4(const float* x,
                   const float* y0,
                   const float* y1,
                   const float* y2,
                   const float* y3,
...
void
NeighborhoodGraph::Search::normalizedCosineSimilarityFloat(NeighborhoodGraph& graph,
                                                           NGT::SearchContainer& sc,
                                                           ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::NormalizedCosineSimilarityFloat,
                              DistanceCheckedSet>(sc, seeds);
}

void
NeighborhoodGraph::Search::cosineSimilarityFloat(NeighborhoodGraph& graph,
                                                 NGT::SearchContainer& sc,
                                                 ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::CosineSimilarityFloat, DistanceCheckedSet>(
        sc, seeds);
}

void
NeighborhoodGraph::Search::normalizedAngleFloat(NeighborhoodGraph& graph,
                                                NGT::SearchContainer& sc,
                                                ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::NormalizedAngleFloat, DistanceCheckedSet>(sc,
                                                                                             seeds);
}

void
NeighborhoodGraph::Search::angleFloat(NeighborhoodGraph& graph,
                                      NGT::SearchContainer& sc,
                                      ObjectDistances& seeds) {
...
void
NeighborhoodGraph::Search::l1Float(NeighborhoodGraph& graph,
                                   NGT::SearchContainer& sc,
                                   ObjectDistances& seeds) {
...
void
NeighborhoodGraph::Search::l2Float(NeighborhoodGraph& graph,
                                   NGT::SearchContainer& sc,
                                   ObjectDistances& seeds) {
...
void
NeighborhoodGraph::Search::normalizedL2Float(NeighborhoodGraph& graph,
                                             NGT::SearchContainer& sc,
                                             ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::NormalizedL2Float, DistanceCheckedSet>(sc,
                                                                                          seeds);
}

void
NeighborhoodGraph::Search::sparseJaccardFloat(NeighborhoodGraph& graph,
                                              NGT::SearchContainer& sc,
                                              ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::SparseJaccardFloat, DistanceCheckedSet>(sc,
                                                                                           seeds);
}

// added by Nyapicom
void
NeighborhoodGraph::Search::poincareFloat(NeighborhoodGraph& graph,
                                         NGT::SearchContainer& sc,
                                         ObjectDistances& seeds) {
...
// added by Nyapicom
void
NeighborhoodGraph::Search::lorentzFloat(NeighborhoodGraph& graph,
                                        NGT::SearchContainer& sc,
                                        ObjectDistances& seeds) {
...
void
NeighborhoodGraph::Search::l1Uint8(NeighborhoodGraph& graph,
                                   NGT::SearchContainer& sc,
                                   ObjectDistances& seeds) {
...
void
NeighborhoodGraph::Search::l2Uint8(NeighborhoodGraph& graph,
                                   NGT::SearchContainer& sc,
                                   ObjectDistances& seeds) {
...
void
NeighborhoodGraph::Search::hammingUint8(NeighborhoodGraph& graph,
                                        NGT::SearchContainer& sc,
                                        ObjectDistances& seeds) {
...
void
NeighborhoodGraph::Search::jaccardUint8(NeighborhoodGraph& graph,
                                        NGT::SearchContainer& sc,
                                        ObjectDistances& seeds) {
...
void
NeighborhoodGraph::Search::normalizedCosineSimilarityFloat16(NeighborhoodGraph& graph,
                                                             NGT::SearchContainer& sc,
                                                             ObjectDistances& seeds) {
...
void
NeighborhoodGraph::Search::cosineSimilarityFloat16(NeighborhoodGraph& graph,
                                                   NGT::SearchContainer& sc,
                                                   ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::CosineSimilarityFloat16, DistanceCheckedSet>(
        sc, seeds);
}

void
NeighborhoodGraph::Search::normalizedAngleFloat16(NeighborhoodGraph& graph,
                                                  NGT::SearchContainer& sc,
                                                  ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::NormalizedAngleFloat16, DistanceCheckedSet>(
        sc, seeds);
}

void
NeighborhoodGraph::Search::angleFloat16(NeighborhoodGraph& graph,
                                        NGT::SearchContainer& sc,
                                        ObjectDistances& seeds) {
...
void
NeighborhoodGraph::Search::l1Float16(NeighborhoodGraph& graph,
                                     NGT::SearchContainer& sc,
                                     ObjectDistances& seeds) {
...
void
NeighborhoodGraph::Search::l2Float16(NeighborhoodGraph& graph,
                                     NGT::SearchContainer& sc,
                                     ObjectDistances& seeds) {
...
void
NeighborhoodGraph::Search::normalizedL2Float16(NeighborhoodGraph& graph,
                                               NGT::SearchContainer& sc,
                                               ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::NormalizedL2Float16, DistanceCheckedSet>(sc,
                                                                                            seeds);
}

void
NeighborhoodGraph::Search::sparseJaccardFloat16(NeighborhoodGraph& graph,
                                                NGT::SearchContainer& sc,
                                                ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::SparseJaccardFloat16, DistanceCheckedSet>(sc,
                                                                                             seeds);
}

// added by Nyapicom
void
NeighborhoodGraph::Search::poincareFloat16(NeighborhoodGraph& graph,
                                           NGT::SearchContainer& sc,
                                           ObjectDistances& seeds) {
...
// added by Nyapicom
void
NeighborhoodGraph::Search::lorentzFloat16(NeighborhoodGraph& graph,
                                          NGT::SearchContainer& sc,
                                          ObjectDistances& seeds) {
...
#endif
void
NeighborhoodGraph::Search::l2Qsint8(NeighborhoodGraph& graph,
                                    NGT::SearchContainer& sc,
                                    ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::L2Qsint8, DistanceCheckedSet>(sc, seeds);
}
void
NeighborhoodGraph::Search::innerProductQsint8(NeighborhoodGraph& graph,
                                              NGT::SearchContainer& sc,
                                              ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::InnerProductQsint8, DistanceCheckedSet>(sc,
                                                                                           seeds);
}
void
NeighborhoodGraph::Search::normalizedCosineSimilarityQsint8(NeighborhoodGraph& graph,
                                                            NGT::SearchContainer& sc,
                                                            ObjectDistances& seeds) {
...
void
NeighborhoodGraph::Search::cosineSimilarityFloatForLargeDataset(NeighborhoodGraph& graph,
                                                                NGT::SearchContainer& sc,
                                                                ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::CosineSimilarityFloat,
                              DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::normalizedAngleFloatForLargeDataset(NeighborhoodGraph& graph,
                                                               NGT::SearchContainer& sc,
                                                               ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::NormalizedAngleFloat,
                              DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::angleFloatForLargeDataset(NeighborhoodGraph& graph,
                                                     NGT::SearchContainer& sc,
                                                     ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::AngleFloat, DistanceCheckedSetForLargeDataset>(
        sc, seeds);
}

void
NeighborhoodGraph::Search::l1FloatForLargeDataset(NeighborhoodGraph& graph,
                                                  NGT::SearchContainer& sc,
                                                  ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::L1Float, DistanceCheckedSetForLargeDataset>(
        sc, seeds);
}

void
NeighborhoodGraph::Search::l2FloatForLargeDataset(NeighborhoodGraph& graph,
                                                  NGT::SearchContainer& sc,
                                                  ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::L2Float, DistanceCheckedSetForLargeDataset>(
        sc, seeds);
}

void
NeighborhoodGraph::Search::normalizedL2FloatForLargeDataset(NeighborhoodGraph& graph,
                                                            NGT::SearchContainer& sc,
                                                            ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::NormalizedL2Float,
                              DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::sparseJaccardFloatForLargeDataset(NeighborhoodGraph& graph,
                                                             NGT::SearchContainer& sc,
                                                             ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::SparseJaccardFloat,
                              DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::poincareFloatForLargeDataset(NeighborhoodGraph& graph,
                                                        NGT::SearchContainer& sc,
                                                        ObjectDistances& seeds) {
    graph
        .searchReadOnlyGraph<PrimitiveComparator::PoincareFloat, DistanceCheckedSetForLargeDataset>(
            sc, seeds);
}

void
NeighborhoodGraph::Search::lorentzFloatForLargeDataset(NeighborhoodGraph& graph,
                                                       NGT::SearchContainer& sc,
                                                       ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::LorentzFloat, DistanceCheckedSetForLargeDataset>(
        sc, seeds);
}

void
NeighborhoodGraph::Search::l1Uint8ForLargeDataset(NeighborhoodGraph& graph,
                                                  NGT::SearchContainer& sc,
                                                  ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::L1Uint8, DistanceCheckedSetForLargeDataset>(
        sc, seeds);
}

void
NeighborhoodGraph::Search::l2Uint8ForLargeDataset(NeighborhoodGraph& graph,
                                                  NGT::SearchContainer& sc,
                                                  ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::L2Uint8, DistanceCheckedSetForLargeDataset>(
        sc, seeds);
}

void
NeighborhoodGraph::Search::hammingUint8ForLargeDataset(NeighborhoodGraph& graph,
                                                       NGT::SearchContainer& sc,
                                                       ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::HammingUint8, DistanceCheckedSetForLargeDataset>(
        sc, seeds);
}

void
NeighborhoodGraph::Search::jaccardUint8ForLargeDataset(NeighborhoodGraph& graph,
                                                       NGT::SearchContainer& sc,
                                                       ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::JaccardUint8, DistanceCheckedSetForLargeDataset>(
        sc, seeds);
}

#ifdef NGT_HALF_FLOAT
void
NeighborhoodGraph::Search::normalizedCosineSimilarityFloat16ForLargeDataset(
    NeighborhoodGraph& graph, NGT::SearchContainer& sc, ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::NormalizedCosineSimilarityFloat16,
                              DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::cosineSimilarityFloat16ForLargeDataset(NeighborhoodGraph& graph,
                                                                  NGT::SearchContainer& sc,
                                                                  ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::CosineSimilarityFloat16,
                              DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::normalizedAngleFloat16ForLargeDataset(NeighborhoodGraph& graph,
                                                                 NGT::SearchContainer& sc,
                                                                 ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::NormalizedAngleFloat16,
                              DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::angleFloat16ForLargeDataset(NeighborhoodGraph& graph,
                                                       NGT::SearchContainer& sc,
                                                       ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::AngleFloat16, DistanceCheckedSetForLargeDataset>(
        sc, seeds);
}

void
NeighborhoodGraph::Search::l1Float16ForLargeDataset(NeighborhoodGraph& graph,
                                                    NGT::SearchContainer& sc,
                                                    ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::L1Float16, DistanceCheckedSetForLargeDataset>(
        sc, seeds);
}

void
NeighborhoodGraph::Search::l2Float16ForLargeDataset(NeighborhoodGraph& graph,
                                                    NGT::SearchContainer& sc,
                                                    ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::L2Float16, DistanceCheckedSetForLargeDataset>(
        sc, seeds);
}

void
NeighborhoodGraph::Search::normalizedL2Float16ForLargeDataset(NeighborhoodGraph& graph,
                                                              NGT::SearchContainer& sc,
                                                              ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::NormalizedL2Float16,
                              DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::sparseJaccardFloat16ForLargeDataset(NeighborhoodGraph& graph,
                                                               NGT::SearchContainer& sc,
                                                               ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::SparseJaccardFloat16,
                              DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::poincareFloat16ForLargeDataset(NeighborhoodGraph& graph,
                                                          NGT::SearchContainer& sc,
                                                          ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::PoincareFloat16,
                              DistanceCheckedSetForLargeDataset>(sc, seeds);
}

void
NeighborhoodGraph::Search::lorentzFloat16ForLargeDataset(NeighborhoodGraph& graph,
                                                         NGT::SearchContainer& sc,
                                                         ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::LorentzFloat16,
                              DistanceCheckedSetForLargeDataset>(sc, seeds);
}
#endif
void
NeighborhoodGraph::Search::l2Qsint8ForLargeDataset(NeighborhoodGraph& graph,
                                                   NGT::SearchContainer& sc,
                                                   ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::L2Qsint8, DistanceCheckedSetForLargeDataset>(
        sc, seeds);
}
void
NeighborhoodGraph::Search::innerProductQsint8ForLargeDataset(NeighborhoodGraph& graph,
                                                             NGT::SearchContainer& sc,
                                                             ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::InnerProductQsint8,
                              DistanceCheckedSetForLargeDataset>(sc, seeds);
}
void
NeighborhoodGraph::Search::normalizedCosineSimilarityQsint8ForLargeDataset(NeighborhoodGraph& graph,
                                                                           NGT::SearchContainer& sc,
                                                                           ObjectDistances& seeds) {
    graph.searchReadOnlyGraph<PrimitiveComparator::NormalizedCosineSimilarityQsint8,
                              DistanceCheckedSetForLargeDataset>(sc, seeds);
...
void
NeighborhoodGraph::setupDistances(NGT::SearchContainer& sc,
                                  ObjectDistances& seeds,
...
#if defined(NGT_SHARED_MEMORY_ALLOCATOR)
        MemoryCache::prefetch(reinterpret_cast<unsigned char*>(objectRepository.get(seeds[i].id)),
                              prefetchSize);
#else
...
#if defined(NGT_SHARED_MEMORY_ALLOCATOR)
            MemoryCache::prefetch(reinterpret_cast<unsigned char*>(
                                      objectRepository.get(seeds[i + prefetchOffset].id)),
                                  prefetchSize);
#else
            MemoryCache::prefetch(
                reinterpret_cast<unsigned char*>(objects[seeds[i + prefetchOffset].id]),
                prefetchSize);
#endif
        }
#endif
...
NeighborhoodGraph::setupDistances(NGT::SearchContainer& sc,
    ...
    for (size_t i = 0; i < seedSize; i++) {
        ...
        seeds[i].distance = comparator(static_cast<void*>(&sc.object[0]),
                                       static_cast<void*>(objectRepository.get(seeds[i].id)),
                                       dimension);
#else
...
void
NeighborhoodGraph::setupSeeds(NGT::SearchContainer& sc,
                              ObjectDistances& seeds,
                              ResultSet& results,
        ...
        for (; neighborptr < neighborendptr; ++neighborptr) {
            ...
            if (!distanceChecked[*neighborptr]) {
                ...
                if (nsPtrsSize < prefetchOffset) {
                    unsigned char* ptr =
                        reinterpret_cast<unsigned char*>(objectRepository.get(*neighborptr));
...
#endif
            Distance distance = COMPARATOR::compare(
                (void*)&sc.object[0],
...
#define add_to_heap(neighborptr, dd)                                       \
    if (dd <= explorationRadius) {                                         \
        result.set(neighborptr->first, dd);                                \
        unchecked.push(result);                                            \
        if (dd <= sc.radius) {                                             \
            results.push(result);                                          \
            if (results.size() > sc.size) {                                \
...
#define NGT_MEMORY_CACHE_PREFETCH 1
    ...
    const size_t dimension = objectSpace->getPaddedDimension();
    bool enable_four = typeid(COMPARATOR) == typeid(PrimitiveComparator::L2Float);
    ReadOnlyGraphNode* nodes = &searchRepository.front();
    ObjectDistance result;
    ObjectDistance target;
    ...
    pair<uint32_t, PersistentObject*>* nsPtrs
        [edgeSize];  // 因为neighborSize是 neighbors->size(), edgeSize两者取小，所以取edgeSize即可。
    size_t idx;
    float distance;
    ...
    while (!unchecked.empty()) {
        ...
        for (idx = 0; idx < nsPtrsSize;) {
            if (enable_four && idx + 4 <= nsPtrsSize) { // one for four
                auto neighborptr0 = nsPtrs[idx];
                auto neighborptr1 = nsPtrs[idx + 1];
                auto neighborptr2 = nsPtrs[idx + 2];
                auto neighborptr3 = nsPtrs[idx + 3];
                float dist0;
                float dist1;
                float dist2;
                float dist3;
                ...
                fvec_L2sqr_batch_4(
                    (float*)&sc.object[0],
                    (float*)&(*static_cast<PersistentObject*>(neighborptr0->second))[0],
                    (float*)&(*static_cast<PersistentObject*>(neighborptr1->second))[0],
                    (float*)&(*static_cast<PersistentObject*>(neighborptr2->second))[0],
                    (float*)&(*static_cast<PersistentObject*>(neighborptr3->second))[0],
                    dimension,
                    dist0,
                    dist1,
                    dist2,
                ...
                add_to_heap(neighborptr0, dist0);
                add_to_heap(neighborptr1, dist1);
                add_to_heap(neighborptr2, dist2);
                add_to_heap(neighborptr3, dist3);
                idx += 4;
            ...
            MemoryCache::prefetch(&(*static_cast<PersistentObject*>(neighborptr->second))[0],
                                  dimension << 2);
#endif
            ...
            sc.distanceComputationCount++;
#endif
            distance = COMPARATOR::compare(
                (void*)&sc.object[0],
                (void*)&(*static_cast<PersistentObject*>(neighborptr->second))[0],
                dimension);  // 这里返回的是double，但是用的是float接受。。。
            add_to_heap(neighborptr, distance);
            idx += 1;
        }
    }
    ...
    while (!unchecked.empty()) {
        ...
        for (size_t i = 0; i < poft; i++) {
            if (!distanceChecked[(*(neighborptr + i)).id]) {
                unsigned char* ptr =
                    reinterpret_cast<unsigned char*>(objectRepository.get((*(neighborptr + i)).id));
                MemoryCache::prefetch(ptr, prefetchSize);
            }
        }
#ifdef NGT_GRAPH_BETTER_FIRST_RESTORE
        ...
        for (; neighborptr < neighborendptr; ++neighborptr) {
            ...
            if ((neighborptr + prefetchOffset < neighborendptr) &&
                ...
                unsigned char* ptr = reinterpret_cast<unsigned char*>(
                    objectRepository.get((*(neighborptr + prefetchOffset)).id));
                MemoryCache::prefetch(ptr, prefetchSize);
            }
            sc.visitCount++;
...
NeighborhoodGraph::removeEdgesReliably(ObjectID id) {
    ...
    if (node.size() == 0) {
        ...
        try {
            ...
            stringstream msg;
            msg << "removeEdgesReliably : Internal error! : cannot remove a node without edges. ID="
                << id;
            msg << ":" << err.what();
            NGTThrowException(msg.str());
        }
    ...
    try {
#if defined(NGT_SHARED_MEMORY_ALLOCATOR)
        for (GraphNode::iterator i = node.begin(repository.allocator);
             i != node.end(repository.allocator);) {
#else
        for (GraphNode::iterator i = node.begin(); i != node.end();) {
#endif
            if (id == (*i).id) {
                cerr << "Graph::removeEdgesReliably: Inner error. Destination nodes include a "
                        "source node. ID="
                     << id << " continue..." << endl;
#if defined(NGT_SHARED_MEMORY_ALLOCATOR)
            ...
            try {
                ...
                cerr << "Graph::removeEdgesReliably: Cannot find edges of a child. ID=" << (*i).id
                     << " continue..." << endl;
#if defined(NGT_SHARED_MEMORY_ALLOCATOR)
                i = node.erase(i, repository.allocator);
#else
            ...
            edge.distance = (*i).distance;
            {
                ...
                GraphNode::iterator ei = std::lower_bound(
                    n->begin(repository.allocator), n->end(repository.allocator), edge);
...
#if defined(NGT_SHARED_MEMORY_ALLOCATOR)
                    for (GraphNode::iterator ni = n->begin(repository.allocator);
                         ni != n->end(repository.allocator);
                         ni++) {
#else
        ...
        for (unsigned int i = 0; i < node.size() - 1; i++) {
            ...
            bool insertionB = false;
            {
...
#if defined(NGT_SHARED_MEMORY_ALLOCATOR)
                GraphNode::iterator ei = std::lower_bound(
                    n.begin(repository.allocator), n.end(repository.allocator), obj);
                ...
                if ((ei == n.end()) || ((*ei).id != obj.id)) {
                    ...
                    for (int i = idx - 1; idx >= 0 && found == false; i--) {
                        if (n[idx - 1].distance != n[i].distance)
                            break;
                        if (n[i].id == obj.id)
                            found = true;
                    }
                    for (int i = idx + 1; idx < (static_cast<int>(n.size()) - 1) && found == false;
                         i++) {
                        if (n[idx + 1].distance != n[i].distance)
                            break;
                        if (n[i].id == obj.id)
            ...
            if (insertionA != insertionB) {
                stringstream msg;
                msg << "Graph::removeEdgeReliably:Warning. Lost connectivity! Isn't this ANNG? ID="
                    << id
#if defined(NGT_SHARED_MEMORY_ALLOCATOR)
                    << ". (" << node.at(i, repository.allocator).id << ":"
                    << node.at(minj, repository.allocator).id << ")";
#else
...
public:
    ...
    TruncationSearchJob&
    operator=(TruncationSearchJob& d) {
        idx = d.idx;
        object = d.object;
        nearest = d.nearest;
        start = d.start;
...
public:
    TruncationSearchSharedData(NGT::NeighborhoodGraph& g,
                               NGT::ObjectID id,
                               size_t size,
                               NGT::Distance lr)
...
public:
    ...
    virtual int
    run() {
        NGT::ThreadPool<TruncationSearchJob, TruncationSearchSharedData*, TruncationSearchThread>::
            Thread& poolThread = (NGT::ThreadPool<TruncationSearchJob,
                                                  TruncationSearchSharedData*,
...
int
NeighborhoodGraph::truncateEdgesOptimally(ObjectID id, GraphNode& results, size_t truncationSize) {
                ...
                for (size_t i = 0; i < nodeSize; i++) {
                    ...
                    GraphNode& delres = *getNode(tid);
                    {
                        ...
                        GraphNode::iterator ei =
                            std::lower_bound(delres.begin(repository.allocator),
                                             delres.end(repository.allocator),
                                             ojob.nearest);
                        if ((*ei).id != ojob.nearest.id) {
                            delres.insert(ei, ojob.nearest, repository.allocator);
#else
                        GraphNode::iterator ei =
                            std::lower_bound(delres.begin(), delres.end(), ojob.nearest);
                        if ((*ei).id != ojob.nearest.id) {
                    ...
                    if (nearestID != id) {
                        ...
                        std::sort(results.begin(repository.allocator),
                                  results.end(repository.allocator));
#else
                        results.push_back(r);
