...
void sgemm_(char *transa, char *transb, int *m, int *n, int *k, float *alpha, float *a, int *lda, float *b,
...
template <typename T> class Matrix {
 public:
  ...
  static void gesvd(char *jobu, char *jobvt, int *m, int *n, double *a, int *lda, double *s, double *u,
                    int *ldu, double *vt, int *ldvt, double *work, int *lwork, int *info) {
    dgesvd_(jobu, jobvt, m, n, a, lda, s, u, ldu, vt, ldvt, work, lwork, info);

  }

  static void gesvd(char *jobu, char *jobvt, int *m, int *n, float *a, int *lda, float *s, float *u, int *ldu,
                    float *vt, int *ldvt, float *work, int *lwork, int *info) {
    sgesvd_(jobu, jobvt, m, n, a, lda, s, u, ldu, vt, ldvt, work, lwork, info);
  }

  static void gemm(char *transa, char *transb, int *m, int *n, int *k, double *alpha, double *a, int *lda,
                   double *b, int *ldb, double *beta, double *c, int *ldc) {
    dgemm_(transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc);
  }

  static void gemm(char *transa, char *transb, int *m, int *n, int *k, float *alpha, float *a, int *lda,
  ...
  static void orgqr(int *m, int *n, int *k, double *a, int *lda, double *tau, double *work, int *lwork,
                    int *info) {
    dorgqr_(m, n, k, a, lda, tau, work, lwork, info);
  }

  static void orgqr(int *m, int *n, int *k, float *a, int *lda, float *tau, float *work, int *lwork,
                    int *info) {
  ...
  static void convert(std::vector<std::string> &strings, std::vector<T> &vector) {
    vector.clear();
  ...
  static void extractVector(const std::string &str, std::vector<T> &vec) {
...
#if !defined(NGT_DISABLE_BLAS)
  static void load(const std::string &file, Matrix<T> &m) {
    loadVectors(file, m);
    m.transpose();
  }

  static void loadVectors(const std::string &file, Matrix<T> &m)
#else
  static void load(const std::string &file, Matrix<T> &m)
#endif
  {
